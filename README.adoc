...
Do ponto de vista técnico, o serviço Debts-Collector recebe notificações de cobrança lançadas pelo Debts, via RabbitMQ, faz o armazenamento no MongoDB.

NOTE: As notificações são recebidas da fila `debt.collector`

Nas datas de 10 dias e 1 dia  antes da data de vencimento, é disparado o envio dos lembretes de pagamentos por `sms`, `email`, `telefonemas` ou `whatsapp`.